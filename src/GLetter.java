...
public class GLetter extends GCompound
{
	...
	public GLetter(String s)
	{
		...
		x1.setVisible(false);
		x2 = new GLine(letter.getX(),letter.getY()-letter.getHeight(),letter.getX()+letter.getWidth(),letter.getY());
		x2.setColor(Color.red);
		x2.setVisible(false);
		//back.setVisible(false);
		add(x1);
		add(x2);
		czech1 = new GLine(letter.getX(),letter.getY()-letter.getHeight()/2,letter.getX()+letter.getWidth()/2,letter.getY());
		czech1.setColor(Color.green);
		czech1.setVisible(false);
		czech2 = new GLine(letter.getX()+letter.getWidth()/2,letter.getY(),letter.getX()+letter.getWidth(),letter.getY()-letter.getHeight());
